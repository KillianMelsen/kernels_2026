...
library(ggplot2)
library(patchwork)
results <- readRDS("DROPS/results/CV2/results.CV2.weights.1-150.rds")
...
p1 / p2
ggsave(filename = "plots/DROPS_CV2_V2.png", dpi = 300, width = 32, height = 32, units = "cm")
# rm(list = ls())


# Plotting per environment:
rm(list = ls())
results <- readRDS("DROPS/results/CV2/results.CV2.rds")
...
#         legend.background = element_rect(fill='transparent'))
# 
# ggsave(filename = "plots/DROPS_CV2_rmse.png", dpi = 300, width = 32, height = 20, units = "cm", background = "transparent")
